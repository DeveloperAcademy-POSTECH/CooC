...
let detailData : [Detail] = [
    Detail(id: 1001, name: "T.O.P", title: "오늘 뭐 먹지",category:"Food", progress:"진행중", date:"2022.04.09",
           detail:"너무 배가 고픈데 오늘은 뭐 먹을까요? 추천해주세요 추천해주세요 추천해주세요 추천해주세요",
           etc:["불고기 전골!!","아무거나 먹으세요","난 모르겠다"],vote_list:["돈까스","치킨"], vote: [200,100]),
    Detail(id: 1002, name: "T.O.P", title: "무슨 게임할까",category:"Game", progress:"진행중", date:"2022.03.29",
    ...
    Detail(id: 1003, name: "T.O.P", title: "드라마 뭐가 재밌지",category:"Movie", progress:"진행중", date:"2022.02.13",
           ...
           etc:["불고기 전골!!","틀"],vote_list:["천국의 계단","너의 목소리가 들려"],vote: [200,100]),
    ...
    Detail(id: 1007, name: "T.O.P", title: "앞으로 뭐 해먹고 살까?",category:"Life", progress:"진행중", date:"2022.01.30",
           ...
           etc:["월급쟁이 ㄱㄱ"],vote_list:["AI","치킨"],vote: [200,100]),
